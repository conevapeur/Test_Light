    ...
    */
    ...
    void Update()
    {
        ...
        if(canLook)
        {
            ...
            if(canSidewalk)
            {
                yRotation = transform.localEulerAngles.y + Input.GetAxis("Mouse X") * mouseSensivity  + Input.GetAxis("Gamepad X") * 9;
                //yRotation = transform.localEulerAngles.y + Input.GetAxis("Gamepad X") * mouseSensivity;
                xRotation = xRotation - Input.GetAxis("Mouse Y") * mouseSensivity - Input.GetAxis("Gamepad Y") * 9;
